...
#define WIFI_SSID "ESP32_555"
#define WIFI_PASS "12345678"
#define LED_ASTABLE_PIN GPIO_NUM_13    // Pin modo astable
#define LED_MONOESTABLE_PIN GPIO_NUM_15 // Pin mono
#define BUTTON_PIN GPIO_NUM_0          // Pin pulso mono
...
static int resistencia_pwm = 1000;  
...
"body { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f0f4f8; text-align: center; padding: 30px; margin: 0; }"
".container { max-width: 800px; margin: auto; }"
".card { background-color: white; padding: 25px; border-radius: 15px; margin-bottom: 25px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1); text-align: left; }"
"h1 { color: #333; margin-bottom: 30px; }"
"h2 { color: #1a73e8; margin-top: 0; }"
"label { display: block; margin: 12px 0 6px; font-weight: bold; }"
"input, button { padding: 10px; font-size: 16px; border-radius: 8px; border: 1px solid #ccc; width: 100%; max-width: 300px; box-sizing: border-box; }"
"button { background-color: #1a73e8; color: white; border: none; cursor: pointer; margin-top: 10px; }"
"button:hover { background-color: #155ab6; }"
".cancel-button { background-color: #e53935; margin-top: 20px; }"
".cancel-button:hover { background-color: #c62828; }"
"#valorResistencia { font-weight: bold; display: inline-block; margin-left: 10px; }"
"</style></head><body><div class=\"container\">"
"<h1>Simulador NE555</h1>"

"<div class=\"card\">"
"<h2>Modo Astable</h2>"
"<label>R1 (Ω):</label><input type=\"number\" id=\"R1\">"
"<label>R2 (Ω):</label><input type=\"number\" id=\"R2\">"
"<label>C1 (F):</label><input type=\"number\" id=\"C1\" step=\"any\">"
"<button onclick=\"calcularAstable()\">Calcular Astable</button>"
"<div id=\"resultadoAstable\"></div><div id=\"tiemposAstable\"></div>"
"</div>"

"<div class=\"card\">"
"<h2>Modo Monoestable</h2>"
"<label>R (Ω):</label><input type=\"number\" id=\"R_mono\">"
"<label>C (F):</label><input type=\"number\" id=\"C_mono\" step=\"any\">"
...
"<input type=\"range\" id=\"resistencia\" min=\"1\" max=\"10000\" step=\"1\" value=\"1000\" oninput=\"mostrarResistencia(this.value)\">"
"<span id=\"valorResistencia\">1000</span> Ω"
"<button onclick=\"enviarResistencia()\">Aplicar Resistencia</button>"
"</div>"

"<button class=\"cancel-button\" onclick=\"cancelarOperaciones()\">Cancelar</button>"
